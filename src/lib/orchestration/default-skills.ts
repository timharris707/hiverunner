...
`,
  ...
  {
    slug: "hiverunner-orchestration-overseer",
    name: "HiveRunner Orchestration Overseer",
    description:
      "Oversee HiveRunner goals, sprint boards, active runs, stale runners, blocked cards, review handoffs, and scope boundaries while agents work.",
    recommendedAgentRoles: ["all", "lead", "product", "program", "qa", "operations"],
    roleHints: [/.*/],
    body: `# HiveRunner Orchestration Overseer

## Use When
- A goal, sprint, or set of HiveRunner tasks needs active supervision.
- The operator asks an agent to watch the board, keep work moving, review blocked/review cards, or prevent scope drift.
- Multiple agents are working and the system needs a concise health/status summary.
...
- Check whether any card is assigned to an offline or unavailable agent, or whether a runner appears active without real progress.
- Keep the stated scope boundaries visible. Do not expand into model routing, CI chasing, app extraction, hosted architecture, or broad redesign unless the current task explicitly asks for it.
- Preserve local lane safety. Use observer lanes only for viewing and use execution lanes only when the operator or task contract allows it.
