...
`,
  },
  {
    ...
    description:
      "Actively supervise HiveRunner goals, sprints, boards, runs, blocked cards, review flow, and multi-agent scope without becoming a hidden manual worker.",
    recommendedAgentRoles: ["lead", "product", "program", "qa", "release", "ops"],
    roleHints: [/\b(ceo|chief|founder|lead|product|pm|program|orchestrator|manager|qa|quality|review|release|steward|ops|operations)\b/i],
