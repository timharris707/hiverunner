...
export const BRANDING = {
  ...
  agentName: process.env.NEXT_PUBLIC_AGENT_NAME || "HiveRunner",
  ...
  agentDescription: process.env.NEXT_PUBLIC_AGENT_DESCRIPTION || "Chief of Staff for this HiveRunner workspace. Orchestrates everything.", // one-line description

  // User/owner information (optional - used in workflow descriptions)
  ownerUsername: process.env.NEXT_PUBLIC_OWNER_USERNAME || "local-owner",
  ownerEmail: process.env.NEXT_PUBLIC_OWNER_EMAIL || "owner@localhost.local",
  ownerCollabEmail: process.env.NEXT_PUBLIC_OWNER_COLLAB_EMAIL || "owner@localhost.local",
  ...
  companyName: process.env.NEXT_PUBLIC_COMPANY_NAME || "HIVERUNNER WORKSPACE",

  // App title (shown in browser tab)
  appTitle: process.env.NEXT_PUBLIC_APP_TITLE || "HiveRunner",
} as const;
