...
export function NotificationDropdown() {
  ...
  // Sync notifications from tasks-log + system when dropdown opens
  ...
  useEffect(() => {
    // Sync on mount to populate from tasks-log, then fetch
    fetch("/api/notifications/sync", { method: "POST" }).catch(() => {}).finally(() => {
      fetchNotifications();
    });
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: notification.read ? "transparent" : "rgba(245, 158, 11, 0.05)",
