...
export function AnimatedFolderOpenIcon({ size = 30, strokeWidth = 1.85 }: LucideProps) {
  return (
    <svg
      className="animated-folder-open-icon"
