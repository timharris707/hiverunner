            ...
            {days.map((day) => {
              ...
              return (
                <div
                  ...
                  className={`p-1 min-h-[48px] overflow-hidden border-r border-gray-800 last:border-r-0 ${
                ...
                >
                  {dayTasks.map((task) => (
                    <div
                      key={task.id}
                      className="w-full bg-emerald-600/20 border-l-2 border-emerald-500 px-2 py-1 rounded text-xs mb-1 overflow-hidden"
                    >
