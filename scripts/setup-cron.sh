...
CRON_ENTRY="0 * * * * cd $PROJECT_DIR && node ./scripts/run-tsx.mjs scripts/collect-usage.ts >> /var/log/hiverunner-usage.log 2>&1"
...
echo
echo "To view logs:"
echo "  tail -f /var/log/hiverunner-usage.log"
